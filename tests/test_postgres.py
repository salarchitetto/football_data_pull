"""Test cases for the PostgresUtils class."""
...
#             zip(self.test_ids, self.test_names, self.test_times),
...
#         create_table_query = f"create table if not exists {self.test_table_name}
#         (id int, division varchar, date varchar);"
